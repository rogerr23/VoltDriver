...
import { WorkSessionForm } from "@/modules/work-sessions/ui/work-session-form";

export const metadata: Metadata = {
  title: "Registrar jornada | VoltDriver",
  description: "Registre seu período de trabalho e confira seus resultados.",
};
...
export default async function NewWorkSessionPage() {
      ...
      <div className="mx-auto w-full max-w-2xl px-5 pb-12 pt-8 sm:px-6 sm:pt-10">
        ...
        <div className="mt-5">
          ...
          <p className="mt-3 max-w-xl text-sm leading-6 text-slate-400 sm:text-base">
            Informe o total do período de trabalho. Não precisa cadastrar cada corrida.
          </p>
        </div>

        {vehicle ? (
          <div className="mt-8">
            <WorkSessionForm defaultDate={getTodayInSaoPaulo()} />
          </div>
        ) : (
          <section className="mt-8 rounded-3xl border border-lime-300/15 bg-lime-300/[0.06] p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-400">
              O consumo e as tarifas do veículo são necessários para calcular energia, lucro e economia.
            </p>
            <Link
              href="/veiculo"
